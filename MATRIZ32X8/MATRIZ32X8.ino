/*################################################################################
# File Name:             ELECTROM@RK_32x8.ino                                             
# Board:                 Arduino UNO/NANO (ATMEGA328)         
# Programming Language:	 Wiring / C /Processing /Fritzing / Arduino IDE          
#						
# Objective:             Scrolling LED dot Matrix
#										  
# Operation:	           Receive via bluetooth and scroll a message over a 32x8 LED dot matrix
#			
# Author:                ELECTROM@RK
# Date:                  jUN 11th, 2024
...
const unsigned char initialText[] PROGMEM ={"HOLA MUNDO"}; //This will be the initial displayed text
